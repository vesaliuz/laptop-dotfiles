...
-- {{{ Helper function for quitmenu
 myquitmenu = {
     { "log out", function() awesome.quit() end, "/usr/share/themes/Sardi-Oblogout-Botticelli/oblogout/logout.svg" },
     { "suspend", "systemctl suspend", "/usr/share/themes/Sardi-Oblogout-Botticelli/oblogout/suspend.svg" },
     { "reboot", "systemctl reboot", "/usr/share/themes/Sardi-Oblogout-Botticelli/oblogout/restart.svg" },
     { "shutdown", "poweroff", "/usr/share/themes/Sardi-Oblogout-Botticelli/oblogout/shutdown.svg" },
     { "cancel", function() quitpopup:hide() end,"/usr/share/themes/Sardi-Oblogout-Botticelli/oblogout/cancel.svg" }
 }
 m_theme={
    border_width=4,
    border_color="#16A085",
...
globalkeys = my_table.join(
    ...
    {description = "show rofi run", group = "hotkeys"}),
    ...
    awful.key({ modkey }, "f", function () awful.util.spawn( browser ) end,
        {description = "firefox-developer-edition" , group = "browser" }),
    ...
    awful.key({ modkey }, "space",    
        function (c)   
            ...
            awful.placement.centered(c)
              ...
              {description = "toggle floating and put window at centre", group = "client"}),
