...
theme.taglist_font                              = "Noto Sans Regular 9"
theme.fg_normal                                 = "#FEFEFE"
theme.fg_focus                                  = "#BBBB00"
...
theme.border_normal                             = "#1D2330"
theme.border_focus                              = "#BEBEBE"
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#777E76", "#4B3B51"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#4B3B51"),
            --arrow("#4B696D", "#4B3B51"),
            ...
            arrow("#4B3B51", "#889FA7"),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#889FA7"),
            arrow("#889FA7", "#CB755B"),
            ...
            --arrow("#8DAA9A", "#CB755B"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#CB755B"),
            arrow("#CB755B", "#777E76"),
