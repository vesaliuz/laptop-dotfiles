...
searchMap.set('Google' , 'https://www.google.cl/search?q=');
searchMap.set('DDG'    , 'https://www.duckduckgo.com/');
searchMap.set('Startpage' , 'https://www.startpage.com/do/dsearch?query=');
searchMap.set('Wiki'   , 'https://en.wikipedia.org/wiki/');
searchMap.set('Youtube', 'https://www.youtube.com/results?search_query=');

searchMap.set('g' , 'https://www.google.cl/search?q=');
searchMap.set('ddg'    , 'https://www.duckduckgo.com/');
searchMap.set('w'   , 'https://en.wikipedia.org/wiki/');
